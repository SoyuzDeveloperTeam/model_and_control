...
SendToBum(0x00000201, 1, 0);       //Команда в БУМ (ПУ БПС - Сеть ВКЛ)
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000208, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000022B, 0, 0);       //команда в БУМ ()
...
SendToBum(0x00000209, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000020A, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000020B, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000020C, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000020D, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000022D, 0, 0);       //команда в БУМ ()
...
SendToBum(0x0000022E, 0, 0);       //команда в БУМ ()
...
SendToBum(0x0000022F, 0, 0);       //команда в БУМ ()
...
SendToBum(0x00000230, 0, 0);       //команда в БУМ ()
...
SendToBum(0x0000022C, 0, 0);       //команда в БУМ ()
...
SendToBum(0x0000022A, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000227, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000226, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000225, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000222, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000223, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000224, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000228, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000229, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000020E, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000020F, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000210, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000211, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000212, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000213, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000214, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000215, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000216, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000217, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000218, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000219, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000021A, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000021B, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000021C, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000021D, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000021E, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x0000021F, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000220, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
...
SendToBum(0x00000221, 1, 0);       //команда в БУМ ()
}
//---------------------------------------------------------------------------
